...
export class LegacyRefactor extends BaseAgent {
     ...
     * 分析文件，生成重构建议
     */
    analyzeForRefactoring(filePath, content, safeMode) {
        const suggestions = [];
     ...
     * 查找可重构的文件
     */
    async findRefactorableFiles(module) {
     ...
     * 生成重构报告
     */
    generateReport(suggestions, options) {
        const lines = [
            '# 老旧项目安全重构报告',
            '',
...
//# sourceMappingURL=legacy-refactor.js.map