...
import { parseErrorType, findAffectedFiles, generateFix, generateVerification, } from './hotfix-analyzer.js';
export class HotfixAgent extends BaseAgent {
    constructor(context) {
        super('HotfixAgent', context);
    }
    async execute(errorDescription, errorLog) {
        try {
     ...
     * 根据错误类型和描述生成根因分析
     */
    analyzeRootCause(errorType, description) {
        const rootCauses = {
            syntax: [
...
//# sourceMappingURL=hotfix-agent.js.map