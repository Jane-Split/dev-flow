...
import { LegacyScanner } from '../scanners/legacy-scanner.js';
    ...
    generateReport(analysis) {
        ...
        if (analysis.techStacks.length > 0) {
            ...
            for (const tech of analysis.techStacks) {
                lines.push(`| ${tech.label} | ${tech.version} | ${tech.confidence}% | ${tech.files.length} | ${tech.migrationTargets.join(', ')} |`);
            }
            lines.push('');
        }
        // 代码复杂度
...
//# sourceMappingURL=legacy-analyzer.js.map