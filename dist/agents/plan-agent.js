...
import { TaskSplitter, Scheduler } from '../planner/index.js';
...
export class PlanAgent extends BaseAgent {
     ...
     * 生成计划文档
     */
    async generateDocument(tasks, schedule) {
...
`;
     ...
     * 获取复杂度分布统计
     */
    getComplexityDistribution(tasks) {
        const distribution = new Map();
        for (const task of tasks) {
