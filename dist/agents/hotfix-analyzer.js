...
// ==================== Java 修复生成 ====================
function generateJavaFix(errorType, file, ext, description) {
    const lower = description.toLowerCase();
    switch (errorType) {
        case 'runtime':
...
// ==================== Python 修复生成 ====================
function generatePythonFix(errorType, file, ext, description) {
    const lower = description.toLowerCase();
    switch (errorType) {
        case 'runtime':
...
// ==================== Go 修复生成 ====================
function generateGoFix(errorType, file, ext, description) {
    const lower = description.toLowerCase();
    switch (errorType) {
        case 'runtime':
