...
export const ANGULARJS_TO_ANGULAR = {
 ...
 * 获取迁移模板
 */
export function getMigrationTemplate(from, to) {
 ...
 * 列出所有可用的迁移路径
 */
export function listMigrationPaths() {
 ...
 * 根据老旧技术栈类型获取推荐的迁移模板
 */
export function getRecommendedTemplates(legacyType) {
...
//# sourceMappingURL=migration-templates.js.map