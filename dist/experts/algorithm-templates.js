...
const longestSubsequenceTemplate = {
    name: '最长子序列',
 ...
 */
export function getAlgorithmTemplate(description) {
 ...
 */
export function generateAlgorithmCode(template, taskName) {
...
//# sourceMappingURL=algorithm-templates.js.map