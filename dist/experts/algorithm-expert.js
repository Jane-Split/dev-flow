...
import { getAlgorithmTemplate, generateAlgorithmCode, } from './algorithm-templates.js';
/**
 * 算法专家 - 处理算法相关的开发任务
 *
 * 能力:
...
export class AlgorithmExpert extends BaseExpert {
     ...
     * 将生成的代码和测试写入文件
     */
    async writeFiles(task, code, test, files, changes) {
        const taskName = this.toFileName(task.name);
...
//# sourceMappingURL=algorithm-expert.js.map