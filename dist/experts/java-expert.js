...
export class JavaExpert extends BaseExpert {
     ...
     */
    generateRestController(className, task, filePath) {
...
`;
     ...
     * 生成 Java Service 类
     */
    generateService(className, task, filePath) {
        const entityName = this.extractEntityName(task.description);
        const packagePath = this.inferPackage(filePath);
        return `package ${packagePath};
...
`;
     ...
     * 生成 JPA Entity 类
     */
    generateJpaEntity(className, task, filePath) {
        const packagePath = this.inferPackage(filePath);
        return `package ${packagePath};
...
`;
     ...
     * 生成 Java 类骨架
     */
    generateClassSkeleton(className, task, filePath) {
        const packagePath = this.inferPackage(filePath);
        return `package ${packagePath};
...
`;
    ...
    extractEntityName(description) {
        ...
        if (cnMatch)
            return this.toClassName(cnMatch[1]);
        return 'Entity';
    }
    /**
     * 根据文件路径推断包名
     */
    inferPackage(filePath) {
...
//# sourceMappingURL=java-expert.js.map