...
| TypeScript / 前端 | TypeScript Contract | `{{REFERENCES_PATH}}design-contract-typescript.md` |
| Python / 后端 | Python Contract | `{{REFERENCES_PATH}}design-contract-python.md` |
| Go / 后端 | Go Contract | `{{REFERENCES_PATH}}design-contract-go.md` |
...
> **详细格式见 `{{REFERENCES_PATH}}runtime-protocol.md` — UI 选择器契约章节。**
