...
| E2E Test（端到端测试） | `.qoder/stages/e2e-test.md` | 进入阶段九 |
| Integration Test（集成测试） | `.qoder/stages/integration-test.md` | 进入阶段十 |
| Delivery（交付报告） | `.qoder/stages/delivery.md` | 进入阶段十一 |
