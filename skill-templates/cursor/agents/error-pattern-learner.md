...
> 具体错误模式定义和预防策略见 `.cursor/references/error-pattern-db.md`。
...
> 具体错误模式定义（P001-P009）见 `.cursor/references/error-pattern-db.md`。
...
> 具体预防策略定义（S001-S009）见 `.cursor/references/error-pattern-db.md`。
...
> 各模式的具体自动更新规则（auto_update_rules）见 `.cursor/references/error-pattern-db.md`。
...
> 知识库更新格式和示例见 `.cursor/references/error-pattern-db.md` 中的「知识库更新」部分。
