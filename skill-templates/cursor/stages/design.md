...
| TypeScript / 前端 | TypeScript Contract | `.cursor/references/design-contract-typescript.md` |
| Python / 后端 | Python Contract | `.cursor/references/design-contract-python.md` |
| Go / 后端 | Go Contract | `.cursor/references/design-contract-go.md` |
...
> **详细格式见 `.cursor/references/runtime-protocol.md` — UI 选择器契约章节。**
