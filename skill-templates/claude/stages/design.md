...
| TypeScript / 前端 | TypeScript Contract | `.claude/references/design-contract-typescript.md` |
| Python / 后端 | Python Contract | `.claude/references/design-contract-python.md` |
| Go / 后端 | Go Contract | `.claude/references/design-contract-go.md` |
...
> **详细格式见 `.claude/references/runtime-protocol.md` — UI 选择器契约章节。**
