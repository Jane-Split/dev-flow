...
- [18. v3.0.0 上下文注入革命 + 结构化分段生成](#18-v300-上下文注入革命--结构化分段生成)
  - [18.1 上下文自动注入系统](#181-上下文自动注入系统)
  - [18.2 50KB 硬约束全面移除](#182-50kb-硬约束全面移除)
  - [18.3 结构化代码分段生成](#183-结构化代码分段生成)
  - [18.4 自动产出校验系统](#184-自动产出校验系统)
- [17. 常见问题](#17-常见问题)
